		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/musicportal/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com' target='_blank'>SMThemes.com</a>, thanks to: <a href='http://www.oktaedr.com/' target='_blank'>www.oktaedr.com</a>, <a href='http://theme.today/' target='_blank'>Theme.Today</a> and <a href='http://www.dpthemes.com/' target='_blank'>dpThemes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
	</div> <?php //footer ?>
